...
public class BrazilStatisticsApp {
    private static Logger log = LoggerFactory.getLogger(BrazilStatisticsApp.class);
    ...
    private void start() {
        ...
        Dataset<Row> df = spark.read()
            ...
            .load("data/ch16/brazil/BRAZIL_CITIES.csv");

        System.out.println("***** Raw datset and schema");
        df.show(100);
        df.printSchema();
    ...
    private long process(Dataset<Row> df, Mode mode) {
        ...
        Dataset<Row> dfMode = addMode(df, mode);
        ...
        Dataset<Row> mcDonaldsPopDf = dfMode
        ...
        Dataset<Row> walmartPopDf = dfMode
        ...
        Dataset<Row> gdpPerCapitaDf = dfMode
            .drop(
                "pop_brazil", "pop_foreign", "post_offices_ct", "cars_ct",
                "moto_ct", "area", "agr_area", "agr_prod", "mc_donalds_ct",
        ...
        Dataset<Row> postOfficeDf = dfMode
        ...
        postOfficeDf = addMode(postOfficeDf, mode);
        ...
        Dataset<Row> agricultureDf = dfMode
    ...
    private Dataset<Row> addMode(Dataset<Row> df, Mode mode) {
        switch (mode) {
            case CACHE:
                df = df.cache();
                break;
